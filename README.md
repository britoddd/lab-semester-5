...
> **Extra note**: Tensorflow GPU acceleration only works on CUDA version 11.2, which is older version. This current setup doesn't work with newer generation GPU
